...
var discord = function() {
  discordClient.on('ready', function() {
      logger.info('[Discord] Successfully connected to channel ' + config.discord.twitchchannel);
  });
          ...
          if(body.stream != null) {
              ...
              if(discordStreamingChecks === 50) {
                ...
                var embed = new Discord.RichEmbed()
                    .setAuthor(config.discord.twitchchannel + " is LIVE on Twitch.TV!",body.stream.channel.logo)
